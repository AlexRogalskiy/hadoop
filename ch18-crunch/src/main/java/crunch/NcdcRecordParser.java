...
// Wersja klasy NcdcRecordParser umożliwiająca serializację
public class NcdcRecordParser implements Serializable {
  ...
  public void parse(String record) {
    ...
    // Usuwanie początkowego znaku plus, ponieważ metoda parseInt źle sobie z nim radzi (w wersjach starszych niż Java 7)
    if (record.charAt(87) == '+') {
